...
const HabitForm: React.FC<HabitFormModalProps> = ({ isOpen, onClose }) => {
  ...
  const handleSave = async () => {
    ...
    const formattedStartDate: string = "2025-7-1"
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-4xl bg-white dark:bg-gray-900 rounded-3xl shadow-2xl transform transition-all duration-300 scale-100 opacity-100 max-h-[90vh] overflow-y-auto">
        {/* ======================================================================================== */}
        {/* MODAL HEADER */}
        {/* ======================================================================================== */}

        <div className="sticky top-0 z-10 flex items-center justify-between p-6 bg-white dark:bg-gray-900 border-b border-gray-200 dark:border-gray-700 rounded-t-3xl">
        ...
        <div className="p-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                <input
                  ...
                  className="w-full bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl px-4 py-3 text-gray-900 dark:text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200"
              ...
              <div className="space-y-4">
                ...
                {/* Time Value Input */}
                {trackingType === "time" && (
                  <div className="relative flex items-center justify-between p-4 bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl">
                    <button
                      onClick={() => handleDecrement(setTimeValue, timeValue)}
                      className="flex items-center justify-center w-12 h-12 rounded-xl bg-white/80 hover:bg-white hover:shadow-md transition-all duration-200 active:scale-95 border border-gray-200/50"
                    >
                    ...
                    <div className="flex items-center justify-center space-x-3">
                      ...
                      <div className="flex items-center space-x-2">
                        <input
                          ...
                          className="bg-transparent text-gray-900 dark:text-white text-center text-2xl font-bold focus:outline-none w-16 border-b-2 border-transparent focus:border-blue-400 transition-all duration-300"
                          placeholder="15"
                          min="1"
                        />
                    ...
                    <div className="flex items-center justify-center space-x-3">
                      ...
                      <div className="flex items-center space-x-2">
                        <input
                          ...
                          className="bg-transparent text-gray-900 dark:text-white text-center text-2xl font-bold focus:outline-none w-16 border-b-2 border-transparent focus:border-green-400 transition-all duration-300"
                          placeholder="1"
                          min="1"
                        />
                        <span className="text-gray-600 dark:text-gray-400 text-lg font-medium">
                ...
                <div>
                  <div className="flex items-center space-x-2 mb-4">
                    {habitIcons.slice(0, 7).map(({ name, icon: Icon }) => (
                      <button
                        ...
                        className={`w-10 h-10 rounded-xl flex items-center justify-center transition-all duration-200 hover:scale-110 ${selectedIcon === name
                          ? "ring-2 ring-gray-800 dark:ring-white ring-offset-2 ring-offset-white dark:ring-offset-gray-900"
                    ...
                    <button
                      ...
                      className="w-10 h-10 rounded-xl flex items-center justify-center bg-gray-100 dark:bg-gray-800 text-gray-600 dark:text-gray-400 hover:scale-110 transition-all duration-200"
                    >
                      <Plus size={18} />
                    </button>
                  </div>
                  ...
                  <div className="flex items-center space-x-2">
                    {defaultColors.slice(0, 6).map((color) => (
                      <button
                        ...
                        className={`w-8 h-8 rounded-lg transition-all duration-200 hover:scale-110 ${selectedColor === color
                          ? "ring-2 ring-gray-800 dark:ring-white ring-offset-2 ring-offset-white dark:ring-offset-gray-900"
                          : ""
                          }`}
                    ...
                    <button
                      ...
                      className="w-8 h-8 rounded-lg border-2 border-dashed border-gray-200 dark:border-gray-700 flex items-center justify-center text-gray-600 dark:text-gray-400 hover:scale-110 transition-all duration-200"
                    >
                      <Plus size={16} />
                    </button>
                  </div>
            ...
            <div className="space-y-2">
              ...
              <div className="space-y-4">
                ...
                <div className="relative">
                  <button
                    ...
                    className="w-full flex items-center justify-between bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl px-4 py-3 text-gray-900 dark:text-white transition-all duration-200 hover:bg-opacity-80"
                  >
                    <span>
                      {
                    ...
                    <div className="absolute top-full left-0 right-0 mt-2 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl shadow-lg z-20 overflow-hidden">
                      {repeatOptions.map((option) => (
                        <button
                          ...
                          className="w-full text-left px-4 py-3 text-gray-900 dark:text-white hover:bg-blue-500 hover:text-white transition-colors duration-150"
                        >
                          {option.label}
                        </button>
                      ))}
                ...
                {repeatability === "every_few_days" && (
                  <div className="flex items-center justify-center py-3 bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl">
                    ...
                    <input
                      ...
                      className="bg-transparent text-gray-900 dark:text-white text-center text-lg font-medium focus:outline-none w-16"
                      min="1"
                      max="30"
                    />
                    ...
                    <div className="flex flex-wrap gap-2 justify-center">
                      {days.map(({ key, label }) => (
                        <button
                          ...
                          className={`px-3 py-2 rounded-lg text-sm font-medium transition-all duration-300 transform hover:scale-105 ${selectedDays.includes(key)
                            ? "bg-blue-500 text-white shadow-lg"
                            : "bg-gray-100 dark:bg-gray-800 text-gray-600 dark:text-gray-400 hover:bg-gray-200 dark:hover:bg-gray-700"
                            }`}
                        >
              ...
              <div className="space-y-2">
                ...
                <button className="w-full flex items-center justify-center bg-gray-100 dark:bg-gray-800 rounded-xl px-4 py-3 text-gray-600 dark:text-gray-400 hover:bg-gray-200 dark:hover:bg-gray-700 transition-all duration-200">
          ...
          <div className="mt-8 flex justify-end space-x-4">
            <button
              onClick={onClose}
              className="px-6 py-3 bg-gray-100 dark:bg-gray-800 text-gray-600 dark:text-gray-400 hover:bg-gray-200 dark:hover:bg-gray-700 font-medium rounded-xl transition-all duration-300 transform hover:scale-105"
            >
              Cancel
            </button>
            <button
      ...
      {showIconPicker && (
        <div className="fixed inset-0 z-60 flex items-center justify-center p-4">
          ...
          />
          <div className="relative bg-white dark:bg-gray-900 rounded-2xl shadow-2xl p-6 max-w-lg w-full max-h-96 overflow-y-auto">
            <h3 className="text-gray-900 dark:text-white text-lg font-semibold mb-4">
              Choose Icon
            </h3>
              ...
              {habitIcons.map(({ name, icon: Icon }) => (
                <button
                  ...
                  className={`w-12 h-12 rounded-xl flex items-center justify-center transition-all duration-200 hover:scale-110 ${selectedIcon === name
                    ? "ring-2 ring-gray-800 dark:ring-white ring-offset-2 ring-offset-white dark:ring-offset-gray-900 bg-blue-500"
                    : "bg-gray-100 dark:bg-gray-800 hover:bg-gray-200 dark:hover:bg-gray-700"
                    }`}
                >
                  <Icon
